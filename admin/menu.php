<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" fill="currentColor"
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li style="text-transform: uppercase;"><a class="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg"
                  width="16" height="16" fill="currentColor" class="bi bi-person-check" viewBox="0 0 16 16">
                  <path
        ...
        <!-- boton -->
        <li class="nav-item">
          <a class="btn btn-outline-warning" onclick=cerrarSesion()><svg xmlns="http://www.w3.org/2000/svg"
