        ...
        <div class="row" style="justify-content: center;">
            <div class="col-5" style="margin-top:3%;">
                ...
                <div class="table-responsive">
                    ...
                    <div class="mt-4">
                        <center>
                            <a style="margin-right: 20px;" href="registrodeusuario.php" class="text-dark"> <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
