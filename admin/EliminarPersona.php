                            ...
                            ?>
                                    <tr>
                                        ...
                                        <div style="justify-content: center;">
                                            <td><a onclick=editarPersona(<?php echo $cons["PersonaId"]; ?>,"<?php echo $cons['Nombre']; ?>","<?php echo $cons["ApellidoP"]; ?>","<?php echo $cons["ApellidoM"]; ?>") class="text-dark text-center btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
